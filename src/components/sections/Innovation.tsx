  ...
  const innovations = [
    {
      icon: (
        <motion.div
          ...
          whileHover={{ scale: 1.2, filter: "drop-shadow(0px 0px 10px #38bdf8)" }}
    ...
    },
    {
      icon: (
        <motion.div
          ...
          whileHover={{ scale: 1.2, filter: "drop-shadow(0px 0px 10px #a855f7)" }}
          className="text-6xl text-gradient-violet"
        >
    ...
    },
    {
      icon: (
        <motion.div
          ...
          whileHover={{ scale: 1.2, filter: "drop-shadow(0px 0px 10px #14b8a6)" }}
          className="text-6xl text-gradient-teal"
        >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            At the forefront of technological advancement, we pioneer solutions
            that don't just meet today's needs—they anticipate tomorrow's
            challenges.
          </p>
        </motion.div>
          ...
          {innovations.map((innovation, index) => (
            ...
            >
              ...
              <div className="lg:w-1/2">
                ...
                >
                  <div className="mb-6">{innovation.icon}</div>
